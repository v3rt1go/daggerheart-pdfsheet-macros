// Enhanced Daggerheart Duality Dice Macro
// Rolls Hope and Fear dice with UI for modifiers, advantage/disadvantage, and die size variants
...
async function rollDaggerheart(
  ...
  console.log("Roll Expression:", rollExpression);
...
new foundry.applications.api.DialogV2({
  window: {
    title: "🎲 Daggerheart Duality Roll 🎲",
    width: 900,
    height: "auto",
    resizable: true,
  },
  content: `
        ...
        <div class="dh-container">
            <div class="dh-title">⚔️ DAGGERHEART DUALITY DICE ⚔️</div>
            ...
            <div class="modifiers-section">
                <div class="modifiers-grid">
                    ...
                    <div class="dh-col">
                        <span class="section-label">🎯 Modifier</span>
                        <input name="modifier" class="modifier-input" type="number" step="1" value="0" placeholder="±0">
                    </div>
                </div>
            </div>
        </div>

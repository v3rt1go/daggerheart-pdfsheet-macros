/**
 * Daggerheart Finesse Roll Macro
 * For use with PDF-Pager label mapping
 * Maps to "Finesse" label in character sheet
 */
...
// Main execution
(async () => {
  // Get the finesse modifier from the PDF field
  let defaultModifier = 0;
  if (actor) {
    const finesseText = ui.pdfpager.getPDFValue(actor, "doc_0_Finesse Value");
    if (finesseText) {
      // Parse the modifier (handles "+2", "-1", "0", etc.)
      const cleanText = finesseText.toString().replace(/^\+/, '');
  ...
  new foundry.applications.api.DialogV2({
    ...
    content: `
        ...
        <div class="dh-container">
            <div class="dh-title">⚔️ FINESSE DUALITY DICE ⚔️</div>
            ...
            <div class="modifiers-section">
                <div class="modifiers-grid">
                    ...
                    <div class="dh-col">
                        <span class="section-label">🎯 Finesse Modifier</span>

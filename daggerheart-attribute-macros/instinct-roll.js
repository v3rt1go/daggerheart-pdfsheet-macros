/**
 * Daggerheart Instinct Roll Macro
 * For use with PDF-Pager label mapping
 * Maps to "Instinct" label in character sheet
 */
...
// Main execution
(async () => {
  // Get the instinct modifier from the PDF field
  let defaultModifier = 0;
  if (actor) {
    const instinctText = ui.pdfpager.getPDFValue(actor, "doc_0_Instinct Value");
    if (instinctText) {
      // Parse the modifier (handles "+2", "-1", "0", etc.)
      const cleanText = instinctText.toString().replace(/^\+/, '');
  ...
  new foundry.applications.api.DialogV2({
    ...
    content: `
        ...
        <div class="dh-container">
            <div class="dh-title">⚔️ INSTINCT DUALITY DICE ⚔️</div>
            ...
            <div class="modifiers-section">
                <div class="modifiers-grid">
                    ...
                    <div class="dh-col">
                        <span class="section-label">🎯 Instinct Modifier</span>

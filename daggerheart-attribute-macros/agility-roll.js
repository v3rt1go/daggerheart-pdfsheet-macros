/**
 * Daggerheart Agility Roll Macro
 * For use with PDF-Pager label mapping
 * Maps to "Agility" label in character sheet
 */
...
// Main execution
(async () => {
  // Get the agility modifier from the PDF field
  let defaultModifier = 0;
  if (actor) {
    const agilityText = ui.pdfpager.getPDFValue(actor, "doc_0_Agility Value");
    if (agilityText) {
      // Parse the modifier (handles "+2", "-1", "0", etc.)
      const cleanText = agilityText.toString().replace(/^\+/, '');
  ...
  new foundry.applications.api.DialogV2({
    ...
    content: `
        ...
        <div class="dh-container">
            <div class="dh-title">⚔️ AGILITY DUALITY DICE ⚔️</div>
            ...
            <div class="modifiers-section">
                <div class="modifiers-grid">
                    ...
                    <div class="dh-col">
                        <span class="section-label">🎯 Agility Modifier</span>

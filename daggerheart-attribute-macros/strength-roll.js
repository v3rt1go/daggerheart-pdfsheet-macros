/**
 * Daggerheart Strength Roll Macro
 * For use with PDF-Pager label mapping
 * Maps to "Strength" label in character sheet
 */
...
// Main execution
(async () => {
  // Get the strength modifier from the PDF field
  let defaultModifier = 0;
  if (actor) {
    const strengthText = ui.pdfpager.getPDFValue(actor, "doc_0_Strength Value");
    if (strengthText) {
      // Parse the modifier (handles "+2", "-1", "0", etc.)
      const cleanText = strengthText.toString().replace(/^\+/, '');
  ...
  new foundry.applications.api.DialogV2({
    ...
    content: `
        ...
        <div class="dh-container">
            <div class="dh-title">⚔️ STRENGTH DUALITY DICE ⚔️</div>
            ...
            <div class="modifiers-section">
                <div class="modifiers-grid">
                    ...
                    <div class="dh-col">
                        <span class="section-label">🎯 Strength Modifier</span>

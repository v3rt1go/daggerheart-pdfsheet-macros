/**
 * Daggerheart Presence Roll Macro
 * For use with PDF-Pager label mapping
 * Maps to "Presence" label in character sheet
 */
...
// Main execution
(async () => {
  // Get the presence modifier from the PDF field
  let defaultModifier = 0;
  if (actor) {
    const presenceText = ui.pdfpager.getPDFValue(actor, "doc_0_Presence Value");
    if (presenceText) {
      // Parse the modifier (handles "+2", "-1", "0", etc.)
      const cleanText = presenceText.toString().replace(/^\+/, '');
  ...
  new foundry.applications.api.DialogV2({
    ...
    content: `
        ...
        <div class="dh-container">
            <div class="dh-title">⚔️ PRESENCE DUALITY DICE ⚔️</div>
            ...
            <div class="modifiers-section">
                <div class="modifiers-grid">
                    ...
                    <div class="dh-col">
                        <span class="section-label">🎯 Presence Modifier</span>
